...
const App = () => {
  ...
  return (
    <ReactLenis root options={{ 
      lerp: 0.07,           /* Wie "rutschig" es ist (0.1 ist normal, 0.05 ist sehr schwer/langsam) */
      duration: 1.2,        /* Wie lange das Nachziehen dauert */
      smoothWheel: true,    /* Aktiviert den Effekt für das Mausrad */
      wheelMultiplier: 1.0  /* Wie schnell man scrollt */
    }}>
      <div className={styles.landingPageWrapper}>
        ...
        <FadeOutSection id="biosync" className={bioSyncStyles.syncSection} delayPercentage={0.3}>
      ...
      <FadeOutSection id="protokolle" className={protocolsSectionStyles.section} delayPercentage={0.65}>
        ...
        <FadeOutSection id="vision" className={visionStyles.section} delayPercentage={0.75}>
